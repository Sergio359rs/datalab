...
```text
Nombre:
[Creación de un robot ayudante para persosas con discapacidad ]

Descripción:
[ Este proyectoo es para las personas con discapacidad el cual necesitan ayuda con funciones basicas]
```
...
¿Por qué ocurrió?
[ PORQUE SE VIOLA LA LLAVCE PRIMARIA ID PROYECTO ]
